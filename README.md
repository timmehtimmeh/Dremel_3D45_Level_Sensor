...
| Part | Qty | Link | Notes|
|------|-----|------|------|
| PCB | 1 | I had the gerbers successfully manufactured at [OSHPark*](https://oshpark.com/shared_projects/k3kUrSLB) as well as [JLCPCB](https://jlcpcb.com/) | *The OEM PCB is a 1mm thickness.  OshPark only makes standard thickness 1.6 mm boards, but the standard thickness worked fine. |
